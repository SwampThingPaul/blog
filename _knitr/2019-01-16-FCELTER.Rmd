...
map=tm_shape(flshoreline)+tm_polygons(col=cols[3],alpha=0.75)+
  ...
  tm_add_legend(type="fill",label="Storms within\n200 km of ENP",col="indianred2")+
  ...
  tm_layout(bg.color=cols[1],legend.outside=TRUE,legend.outside.position=c("left","top"),
            ...
            legend.text.size=0.8,legend.title.size=0.8)


```

```{r hurricane_map,echo=FALSE,out.width="75%",out.height="75%",fig.cap="Atlantic Basin Hurricane and Tropical Storm center lines between 1851 and 2017."}
#tmap_leaflet(map)
map
```
