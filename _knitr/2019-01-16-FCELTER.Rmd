...
```{r, out.width="80%",echo=FALSE,fig.align="center",fig.cap="The view from Taylor Slough bridge along the main park road."}
...
```{r, out.width="50%",echo=FALSE,fig.align="center",fig.cap="Map of the study area with monitoring locations and ecosystems identified from stations within the Florida Coastal Everglades Long Term Ecological Research network in Everglades National Park"}
...
```{r STA area,echo=F,message=F,warning=F}
...
```{r sta area,fig.height=3.5,fig.width=6,echo=FALSE,fig.align="center",fig.cap="Current and expected (estimated) cumulative stormwater treatment area (STA) and flow-equalization basin (FEB) coverage with the Everglades ecosystem. Actual cumulative annual areal extent of STA and FEB coverage identified by grey points. Dashed vertical line indicates to current."}
...
```{r hurricane map,echo=F,out.width="100%",fig.align="center",fig.cap="Atlantic Basin Hurricane and Tropical Storm center lines."}
tmap_leaflet(map)
```

```{r hurricane freq,fig.height=3.5,fig.width=6,echo=FALSE,fig.align="center",fig.cap="Frequency of Tropical Storms or Hurricanes that pass within 200 km of ENP. Based on Florida Water Year (May 1^st^ to Apirl 30^th^)."}
...
```{r, out.width="80%",echo=FALSE,fig.align="center",fig.cap="Typical wetland water budget from Kadlec and Wallace (2009)."}
knitr::include_graphics("../images/20190116_FCE/waterbudget.jpg")
```


```{r WL data,include=FALSE,warning=FALSE,message=FALSE,echo=FALSE}
...
```{r WL plot,fig.height=4,fig.width=6,echo=FALSE,fig.align="center",fig.cap="Daily water level of northern WCA-3A (CA3-62 and CA3-63 sites) used to indicate high water conditions."}
...
```{r High water,fig.height=4,fig.width=6,echo=FALSE,fig.align="center",fig.cap="Percent of days above high water crtiera within Water Conservation 3A."}
par(family="serif",mar=c(1,1.5,1,0.75),oma=c(2,3,0.25,0.25),mgp=c(3,1,0));
...
```{r rainfall data,include=FALSE,warning=FALSE,message=FALSE,echo=FALSE}
...
```{r rainfall plot,fig.height=4,fig.width=6,echo=FALSE,fig.align="center",fig.cap="Annual total rainfall (area-weighted) and Standardized Rainfall Anomaly Index across Everglades National Park. Dashed line indicates drought threshold. "}
