...
```{r 1, out.width="80%",echo=FALSE,fig.align="center"}
knitr::include_graphics("../images/20170823_TSMap.jpg")
```
<center>Map of regional ambient and legally mandated monitoring.</center>

<br>
<br>
```{r 2, out.width="80%",echo=FALSE,fig.align="center"}
knitr::include_graphics("../images/20170823_TPPlot.jpg")
```
<center>
